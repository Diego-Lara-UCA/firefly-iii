...
<body>
    ...
    @include('pdf._table', [
        'title' => 'Account per category',
        'headers' => $accountPerCategoryTableHeaders,
        'data' => $accountPerCategoryTableData
    ])
    @include('pdf._table', [
        'title' => 'Average expense per destination account',
        'headers' => ['Account', 'Spent (average)', 'Total', 'Transaction count'],
        'data' => $avgExpenseDestinationTableData
    ])
    @include('pdf._table', [
        'title' => 'Average earning per source account',
        'headers' => ['Account', 'Earned (average)', 'Total', 'Transaction count'],
        'data' => $avgEarningSourceTableData
    ])
    @include('pdf._table', [
        'title' => 'Expenses (top 10)',
        'headers' => ['Description', 'Date', 'Account', 'Category', 'Amount'],
        'data' => $topExpensesTableData
    ])
    @include('pdf._table', [
        'title' => 'Revenue / income (top 10)',
        'headers' => ['Description', 'Date', 'Account', 'Category', 'Amount'],
        'data' => $topRevenueTableData
    ])
